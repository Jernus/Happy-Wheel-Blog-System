 ...
 <div class="card" id="articleBody">
     ...
     <div id="createArticleBody">
         <form action="./saveArticle" method="post">
             ...
             <div id="createTitle">
                 <input class="form-control" type="text" id="newTitle" name="newTitle" value="${article.title}">
             </div>
             <br>
             <label class="text-warning"><b><strong>Content</strong></b></label><br>
             <div id="createContent">
                 <textarea class="form-control" rows="3" id="newContent" cols="93" name="newContent">${article.content}</textarea>
             </div>
